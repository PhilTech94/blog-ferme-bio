 ...
 */
final class Version20260128105732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(50) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, article_id INT DEFAULT NULL, INDEX IDX_16DB4F897294869C (article_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
